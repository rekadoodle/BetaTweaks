...
public class SettingInfo {
	...
	public static String getConfigComment(SBase<?> setting) {
		...
		if(setting == cfg.customFullscreenRes) {
			return "Format like this: width,height,bbp,freq";
		}
		return null;
	}
	...
	public static String[] getInfo(SBase<?> setting) {
		...
		if(setting == cfg.customFullscreenRes) {
			return new String[] {
				...
				"Drag the middle part or click the buttons to change.",
				"Use [" + Keyboard.getKeyName(CustomFullscreenRes.toggleKeybind.keyCode) + "] to toggle.",
				"NOTE: This may cause crashes randomly."
			};
		}
		return null;
	}
